...
const Register = () => {
  ...
  return (
    <PageWrapper>
      <Helmet><title>Create Account - XRSave-YT</title></Helmet>
      <div className="min-h-screen flex items-center justify-center px-4 py-20">
        <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-md">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500 mt-2">Get download history and more</p>
          </div>
          ...
          <div className="card p-6">
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              <div>
                ...
                <input {...register('name')} type="text" placeholder="Your name" className="input-field" />
              ...
              <div>
                ...
                <div className="relative">
                  <input {...register('password')} type={showPass ? 'text' : 'password'} placeholder="Min 6 characters" className="input-field pr-10" />
